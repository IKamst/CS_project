...
file = open("test_incorrectly_classified_baseline.txt", "r")

words, correct_class, wrong_class = [], [], []
# f.write("word correct_class classification\n")
for x in file: 
	line = x.split()
	if line:
		words.append(line[0])
...
percent = dict((x, round((value/1336)*100, 2)) for x,value in wrong_counts.items())
print(percent)
...
plt.title('Percentages of the Incorrectly Classified Semantic Tags by the Baseline', fontsize = 18, fontweight='bold')
